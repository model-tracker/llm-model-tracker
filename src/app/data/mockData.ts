...
export const providers: ProviderInfo[] = [
  { id: 'openai',  name: 'OpenAI',         logo: '/logos/openai.png', activeModels: llmModels.filter(m => m.provider === 'OpenAI'         && m.status === 'Active').length,     deprecatedModels: llmModels.filter(m => m.provider === 'OpenAI'         && m.status === 'Deprecated').length, upcomingModels: llmModels.filter(m => m.provider === 'OpenAI'         && m.status === 'Upcoming').length },
  { id: 'anthropic', name: 'Anthropic',    logo: '/logos/anthropic.png', activeModels: llmModels.filter(m => m.provider === 'Anthropic'      && m.status === 'Active').length,     deprecatedModels: llmModels.filter(m => m.provider === 'Anthropic'      && m.status === 'Deprecated').length, upcomingModels: llmModels.filter(m => m.provider === 'Anthropic'      && m.status === 'Upcoming').length },
  { id: 'google',  name: 'Google Gemini',  logo: '/logos/google.png', activeModels: llmModels.filter(m => m.provider === 'Google'         && m.status === 'Active').length,     deprecatedModels: llmModels.filter(m => m.provider === 'Google'         && m.status === 'Deprecated').length, upcomingModels: llmModels.filter(m => m.provider === 'Google'         && m.status === 'Upcoming').length },
  { id: 'azure',   name: 'Azure OpenAI',   logo: '/logos/azure.png', activeModels: llmModels.filter(m => m.provider === 'Azure OpenAI'   && m.status === 'Active').length,     deprecatedModels: llmModels.filter(m => m.provider === 'Azure OpenAI'   && m.status === 'Deprecated').length, upcomingModels: llmModels.filter(m => m.provider === 'Azure OpenAI'   && m.status === 'Upcoming').length },
  { id: 'xai',     name: 'xAI',            logo: '/logos/xai.png', activeModels: llmModels.filter(m => m.provider === 'xAI'            && m.status === 'Active').length,     deprecatedModels: llmModels.filter(m => m.provider === 'xAI'            && m.status === 'Deprecated').length, upcomingModels: llmModels.filter(m => m.provider === 'xAI'            && m.status === 'Upcoming').length },
  { id: 'bedrock', name: 'Amazon Bedrock', logo: '/logos/amazon.png', activeModels: llmModels.filter(m => m.provider === 'Amazon Bedrock' && m.status === 'Active').length,     deprecatedModels: llmModels.filter(m => m.provider === 'Amazon Bedrock' && m.status === 'Deprecated').length, upcomingModels: llmModels.filter(m => m.provider === 'Amazon Bedrock' && m.status === 'Upcoming').length },
];
